...
module xbar_dbg (
  ...
  output tlul_pkg::tl_h2d_t tl_lc_ctrl__dbg_o,
  input  tlul_pkg::tl_d2h_t tl_lc_ctrl__dbg_i,
  ...
  assign tl_lc_ctrl__dbg_o = tl_asf_5_ds_h2d;
  assign tl_asf_5_ds_d2h = tl_lc_ctrl__dbg_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_4_us_h2d.a_address &
      ...
      dev_sel_s1n_4 = 2'd1;
                  ...
                  ~(ADDR_MASK_LC_CTRL__DBG)) == ADDR_SPACE_LC_CTRL__DBG) begin
      dev_sel_s1n_4 = 2'd2;
end
  end
