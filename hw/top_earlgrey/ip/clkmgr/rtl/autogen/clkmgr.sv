...
#(
  ...
  // clock gated indication for alert handler
  prim_lc_sender u_prim_lc_sender_clk_proc_main (
    .clk_i(clk_main_i),
    .rst_ni(rst_main_ni),
    .lc_en_i(((clk_main_en) ? lc_ctrl_pkg::Off : lc_ctrl_pkg::On)),
    .lc_en_o(cg_en_o.clk_proc_main)
  );
  ...
  assign clk_main_aes_combined_en = clk_main_aes_en & clk_main_en;
  prim_clock_gating #(
  ...
  assign clk_main_hmac_combined_en = clk_main_hmac_en & clk_main_en;
  prim_clock_gating #(
    .FpgaBufGlobal(1'b0) // This clock is used primarily locally.
  ) u_clk_main_hmac_cg (
    .clk_i(clk_main_root),
  ...
  assign clk_main_kmac_combined_en = clk_main_kmac_en & clk_main_en;
  prim_clock_gating #(
    .FpgaBufGlobal(1'b0) // This clock is used primarily locally.
  ) u_clk_main_kmac_cg (
    .clk_i(clk_main_root),
  ...
  assign clk_main_otbn_combined_en = clk_main_otbn_en & clk_main_en;
  prim_clock_gating #(
    .FpgaBufGlobal(1'b0) // This clock is used primarily locally.
  ) u_clk_main_otbn_cg (
    .clk_i(clk_main_root),
  ...
  assign clk_io_div4_otbn_combined_en = clk_io_div4_otbn_en & clk_io_div4_en;
  prim_clock_gating #(
    .FpgaBufGlobal(1'b0) // This clock is used primarily locally.
