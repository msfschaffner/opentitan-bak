...
package lc_ctrl_reg_pkg;
  ...
  parameter logic [DbgAw-1:0] LC_CTRL_DBG_OFFSET = 12'h 0;
  parameter int unsigned      LC_CTRL_DBG_SIZE   = 'h 1000;
  parameter int unsigned      LC_CTRL_DBG_IDX    = 0;
