...
class FlowCfg():
    ...
    def __init__(self, flow_cfg_file, proj_root, args):
        ...
        self.results_md = ""
        # results to be published or mailed out
        # these can be optionally be sanitized in case certain info is not publishable
        self.email_results_md = ""
        self.publish_results_md = ""
        self.sanitize_email_results = ""
        self.sanitize_publish_results = ""
        # summary results, generated by over-arching cfg file
    ...
    def _post_parse_flow_cfg(self):
        ...
        # Convert these to boolean
        if self.sanitize_email_results in ["", "False"]:
            self.sanitize_email_results = False
        elif self.sanitize_email_results == "True":
            self.sanitize_email_results = True

        if self.sanitize_publish_results in ["", "False"]:
